<?php
namespace Aireset\Http\Controllers\Api\Jackpots
{
    class JackpotsController extends \Aireset\Http\Controllers\Api\ApiController
    {
        ...
        public function index(\Illuminate\Http\Request $request)
        {
            ...
            $jackpots = \Aireset\JPG::orderBy('date_time', 'DESC');
            if( $request->id != '' )
            {
            ...
            return $this->respondWithPagination($jackpots, new \Aireset\Transformers\JackpotTransformer());
        }
    }
