...
namespace Aireset
{
    class User extends \Illuminate\Foundation\Auth\User implements \Tymon\JWTAuth\Contracts\JWTSubject
    {
        ...
        protected $presenter = 'Aireset\Presenters\UserPresenter';
        ...
        {
            return $this->hasMany('Aireset\Services\Logging\UserActivity\Activity', 'user_id');
        }
        public function referral()
        {
            return $this->belongsTo('Aireset\User', 'parent_id');
        }
        public function rel_shops()
        {
            return $this->hasMany('Aireset\ShopUser', 'user_id');
        }
        ...
        {
            $token = app('Aireset\Services\Auth\Api\TokenFactory')->forUser($this);
            return ['jti' => $token->id];
        }
