...
namespace Aireset
{
    class Game extends \Illuminate\Database\Eloquent\Model
    {
        ...
        public static $values = [
            ...
            'bet' => [
			    '0.01, 0.02, 0.05, 0.10, 0.20, 0.30, 0.40, 0.50, 0.60, 0.70, 0.80, 0.90, 1.00, 1.50, 2.00, 2.50, 3.00, 3.50, 4.00, 4.50, 5.00, 10.00, 20.00',
        ...
        {
            return $this->hasOne('Aireset\JPG', 'id', 'jpg_id');
        }
        public function game_win()
        {
            return $this->hasOne('Aireset\GameWin', 'game_id', 'original_id');
        }
        public function game_bank()
        {
            return $this->hasOne('Aireset\GameBank', 'shop_id', 'shop_id');
        }
        public function statistics()
        {
            $shop_id = (\Auth::check() ? \Auth::user()->shop_id : 0);
            return $this->hasMany('Aireset\StatGame', 'game', 'name')->where('shop_id', $shop_id)->orderBy('date_time', 'DESC');
        }
        public function categories()
        {
            return $this->hasMany('Aireset\GameCategory', 'game_id');
        }
